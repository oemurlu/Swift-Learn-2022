...
class AnaSayfa: UIViewController {
    ...
    //bu kisilerListesi'ni VM'de olusturmak daha dogru bence. Benim bildigim controller'da boyle seyler olusturulmaz. Kendim projeyi kopyalayip kisilerListesi'ni (farkli adla) VM'de olusturup buraya implemente edip denedim calisiyor. Ram kullanimi da ayni.
